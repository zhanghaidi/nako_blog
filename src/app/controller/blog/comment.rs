...
pub struct CreateValidate {
    ...
    #[validate(
        required(message = "你的联系邮箱不能为空"),
        email(message = "你的联系邮箱格式错误")
    )]
    email: Option<String>,
...
pub async fn create(
    ...
    let create_data = comment::CommentModel::create(
        db,
