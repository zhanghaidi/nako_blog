...
use crate::app::entity::{friendlink, friendlink::Entity as Friendlink};
...
impl FriendlinkModel {
    ...
    // 搜索
    pub async fn search_count(db: &DbConn, wheres: FriendlinkWhere) -> Result<u64, DbErr> {
        Friendlink::find()
    ...
    pub async fn list_open(db: &DbConn) -> Result<Vec<friendlink::Model>, DbErr> {
        Friendlink::find()
